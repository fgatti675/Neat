...
public class CreditCardView extends FrameLayout {
    ...
    public void setCardHolderName(String cardHolderName) {
        ...
        if(cardHolderName.length() > 26) {
            cardHolderName = cardHolderName.substring(0,26);
        }
    ...
    public void setCardHolderNameHint(String cardHolderName) {
        ((TextView)findViewById(TEXTVIEW_CARD_HOLDER_ID)).setHint(cardHolderName);
    }
