...
public class BindingUtils {
    ...
    private static Map<String, Integer> iconMap = new HashMap<String, Integer>() {{
        ...
        put("fill_17", R.drawable.item_fill_17);
    ...
    public static void bindPriceText(TextView view, Item item) {
    ...
    @BindingAdapter({"bind:itemImage"})
    public static void bindImage(ImageView view, Item item) {
        if (item.imageUrl != null) {
            Glide.with(view.getContext()).load(item.imageUrl)
                    .centerCrop()
