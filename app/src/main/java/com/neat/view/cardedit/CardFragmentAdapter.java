...
public class CardFragmentAdapter extends FragmentStatePagerAdapter implements IActionListener {
    ...
    public interface ICardEntryCompleteListener {
        ...
        void onCardEntryEdit(int currentIndex, String entryValue, boolean validValue);
    }
    ...
    public Fragment getItem(int position) {
        switch (position) {
            case 0:
                return mCardNumberFragment;
            case 1:
                return mCardExpiryFragment;
            case 2:
                return mCardCVVFragment;
            case 3:
                return mCardNameFragment;
        }
    ...
    @Override
    public void onEdit(CreditCardFragment fragment, String edit, boolean validValue) {
        int index = getIndex(fragment);

        if (index >= 0 && mCardEntryCompleteListener != null) {
            mCardEntryCompleteListener.onCardEntryEdit(index, edit, validValue);
        }
    }
